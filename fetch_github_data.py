...
def main():
    ...
    # Search for users in Hyderabad with >100 followers
...
#         f.write(f"""# GitHub Users in Hyderabad

# This repository contains data about GitHub users in Hyderabad with over 100 followers and their repositories.

# ## Files

# 1. `users.csv`: Contains information about {len(users)} GitHub users in Hyderabad with over 100 followers
